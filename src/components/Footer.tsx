export default function Footer() {
    return (
        <footer className="bg-white dark:bg-gray-900 mt-6 pt-6">
			<div className="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
				<div>
					<h2 className="mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Company</h2>
					<ul className="text-gray-500 dark:text-gray-400">
						<li className="mb-4">
							<a href="#0" className=" hover:underline">About</a>
						</li>
						<li className="mb-4">
							<a href="#0" className="hover:underline">Careers</a>
						</li>
						<li className="mb-4">
							<a href="#0" className="hover:underline">Brand Center</a>
						</li>
						<li className="mb-4">
							<a href="#0" className="hover:underline">Blog</a>
						</li>
					</ul>
				</div>
				<div>
					...
					<ul className="text-gray-500 dark:text-gray-400">
						<li className="mb-4">
							<a href="#0" className="hover:underline">Discord Server</a>
						</li>
						<li className="mb-4">
							<a href="#0" className="hover:underline">Twitter</a>
						</li>
						<li className="mb-4">
							<a href="#0" className="hover:underline">Facebook</a>
						</li>
						<li className="mb-4">
							<a href="#0" className="hover:underline">Contact Us</a>
						</li>
					</ul>
				</div>
				<div>
					...
					<ul className="text-gray-500 dark:text-gray-400">
						...
						<li className="mb-4">
							<a href="#0" className="hover:underline">Licensing</a>
						</li>
						<li className="mb-4">
							<a href="#0" className="hover:underline">Terms &amp; Conditions</a>
						</li>
					</ul>
				</div>
				<div>
					...
					<ul className="text-gray-500 dark:text-gray-400">
						<li className="mb-4">
							<a href="#0" className="hover:underline">iOS</a>
						</li>
						<li className="mb-4">
							<a href="#0" className="hover:underline">Android</a>
						</li>
						<li className="mb-4">
							<a href="#0" className="hover:underline">Windows</a>
						</li>
						<li className="mb-4">
							<a href="#0" className="hover:underline">MacOS</a>
						</li>
					</ul>
				</div>
			</div>
			<div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
				...
				<div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
					<a href="#0" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
